...
2. If -1 is set in one item, all items are removed!, but…
3. Try to add a new item product, the shopping cart reappears!
4. We set 0 and press update. The price item still is shown in cart!
5. Total price is round! (shopping cart box)
6. Cart contents top button has a spelling mistake
